...
/* ============================================================
   TIMI STEMI RISK CALCULATOR
   ============================================================ */
var TIMI_MORT = {0:'0.8%',1:'1.6%',2:'2.2%',3:'4.4%',4:'7.3%',5:'12.4%',6:'16.1%',7:'23.4%',8:'26.8%'};
function tglTimi(el){
  // mutually-exclusive group (age)
  var grp = el.getAttribute('data-grp');
  if(grp && !el.classList.contains('sel')){
    document.querySelectorAll('#timiCalc .calc-opt[data-grp="'+grp+'"]').forEach(function(o){ if(o!==el) o.classList.remove('sel'); });
  }
  el.classList.toggle('sel');
  var total=0;
  document.querySelectorAll('#timiCalc .calc-opt.sel').forEach(function(o){ total+=parseInt(o.getAttribute('data-pts'),10)||0; });
  document.getElementById('timiTotal').textContent=total;
  var mort = total>8 ? '35.9%' : (TIMI_MORT[total]||'0.8%');
  document.getElementById('timiInterp').innerHTML='Estimated 30-day mortality: <strong>'+mort+'</strong>';
}
